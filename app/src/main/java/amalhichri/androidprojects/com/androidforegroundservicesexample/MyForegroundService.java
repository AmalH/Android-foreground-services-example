...
public class MyForegroundService extends Service implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    private Notification prepareNotification() {
        ...
        Intent lPauseIntent = new Intent(this, MyForegroundService.class);
        ...
        Intent lStopIntent = new Intent(this, MyForegroundService.class);
        ...
        switch (mStateService) {
            ...
            case Statics.STATE_SERVICE.PAUSE:
            ...
            case Statics.STATE_SERVICE.PREPARE:
        ...
        if (lWifi != null && lWifi.isConnected()) {
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.HONEYCOMB_MR1) {
                mWiFiLock = ((WifiManager) getApplicationContext().getSystemService(Context.WIFI_SERVICE)).createWifiLock(
                        WifiManager.WIFI_MODE_FULL_HIGH_PERF, MyForegroundService.class.getSimpleName());
            } else {
                mWiFiLock = ((WifiManager) getApplicationContext().getSystemService(Context.WIFI_SERVICE)).createWifiLock(
                        WifiManager.WIFI_MODE_FULL, MyForegroundService.class.getSimpleName());
            }
            mWiFiLock.acquire();
